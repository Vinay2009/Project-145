...
label_name["text"] = "Vinay Datta"
label_dob["text"] = "June 26 2009"
label_pin["text"] = "12345"
label_address["text"] = "Royal Heights, Hyderabad"
label_vehicle_type["text"] = "Sedan, Hatchback, SUV"
...
def license():
    ...
    pin = 12345
    print(type(pin))
    address = "Royal Heights,Hyderabad"
    print(type(address))
